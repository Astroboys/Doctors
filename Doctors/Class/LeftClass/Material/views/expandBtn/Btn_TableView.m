...
-(void)addViewData
{
    ...
    [self.m_btn setTitleColor:DWColor(166,171,185) forState:UIControlStateNormal];
    self.m_btn.titleLabel.font = [UIFont systemFontOfSize:15];
...
{
    [self.m_btn setTitle:name forState:UIControlStateNormal];
}
-(void)expandableButton:(UIButton*)sender
{
    ...
    [UIView animateWithDuration:0.2f animations:^{
        ...
        if (self.m_bHidden) {
            ...
            self.frame = CGRectMake(self.frame.origin.x, self.frame.origin.y, self.m_btn.frame.size.width, 150);
        }else{
